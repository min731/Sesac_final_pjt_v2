...
class Preprocess:
    def __init__(self, word2index_dic=local_path+'data/dic/chatbot_dict.bin' ,userdic=local_path+'data/dic/userdict_intent_classify_v3(library)_all_bname_wname_v2.txt'): # userdic 인자에는 사용자 정의 사전 파일 경로 입력가능
