...
## BFS 메서드 정의
def bfs (graph, node, visited,user_input):
    ...
    while queue:
        ...
        ans , next_node = poped_node.task(graph,poped_node,user_input,ans)
...
def chatbot_start(user_input):
    ...
    ans = bfs(graph, node1, visited,user_input)
